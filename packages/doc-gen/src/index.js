 ...
 * Instead of writing a recursive readdirSync function, we use Bun's
...
/**
 * 2. REPLACEMENT: Top-Level Await & Bun.write
 * We make the main function async (Node requires wrappers, Bun doesn't).
 * We also use Bun.write which is cleaner than fs.writeFileSync.
 */
async function generateMarkdown() {
  const files = await getFiles(); // Await our new Glob function
  let totalItems = 0;
